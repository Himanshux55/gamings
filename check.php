...
if($email == "" && $password == "" && $playid == "" && $phone == "" && $level == "" && $day == "" && $month == "" && $year == "" && $login == ""){
...
<tr>
<th style="padding:3px;width: 35%; text-align: left;" height="25px"><b>DATE OF BIRTH</th>
<th style="padding:3px;width: 65%; text-align: center;"><b>'.$day.' '.$month.' '.$year.'</th>
</tr>
